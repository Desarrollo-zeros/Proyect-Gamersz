 ...
 *
 * Copyright (C) 2013 Proyect-Gamersz [WS] <http://wowsource.info/>
 *
 * Dont Share The SourceCode
 * and read our Proyect-Gamersz Terms
 *
 */

// ToDo: Get correctly weapon equipment for baleroc. 101035 - trigger bridge visual, after that it summons.
#include "ObjectMgr.h"
#include "ScriptMgr.h"
